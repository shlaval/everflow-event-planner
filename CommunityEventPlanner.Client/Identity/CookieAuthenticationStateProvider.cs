using CommunityEventPlanner.Client.Identity.Models;
...
namespace CommunityEventPlanner.Client.Identity
{
    /// <summary>
    ...
    public class CookieAuthenticationStateProvider : AuthenticationStateProvider, IAccountManagement
    {
        ...
        {
            _httpClient = httpClientFactory.CreateClient("AuthCookieClient");
        }
